                ...
                <div class="d-flex">
                    ...
                    <div id="nav-right" class="align-self-center ls-2">
                        ...
                        <div id="contact-wrapper" class="d-inline bg-primary align-middle">
                            <a id="nav-button" href="{{ route('auth.index_login') }}" class="btn btn-light ls-2 rounded-0 border border-dark px-3 pb-2 pt-1 text-d-blue">
                                <span class="fs-7 text-uppercase">admin</span>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="landing-left" class="col-6 position-relative" style="height: 100vh;">
                        <div id="lading-left-content" class="position-absolute top-50 start-0 translate-middle-y" style="margin-right: 100px">
                            ...
                            <div id="landing-footer-wrapper" class="pt-5">
                                ...
                                <div id="image-wrapper" class="row mt-3">
                                    <div id="first-logo-wrapper" class="col-6">
                                        <span class="p-1 border border-dark fw-bold align-middle">UI</span>
                                        <span class="text-d-blue fw-bold align-middle fs-2">Path</span>
                                        <span class="text-d-blue fs-6 fw-bold">&#8482;</span>
                                        <span class="text-muted fw-bold align-middle fs-2">Partner</span>
                                    </div>
                                    <span id="second-logo-wrapper" class="col-6">
                                        <span class="text-d-blue fw-bold align-middle fs-2">Clutch</span>
                                        <span class="fs-6 align-middle"><i class="bi bi-star-fill"></i></span>
                                        <span class="fs-6 align-middle"><i class="bi bi-star-fill"></i></span>
                                        <span class="fs-6 align-middle"><i class="bi bi-star-fill"></i></span>
                                        <span class="fs-6 align-middle"><i class="bi bi-star-fill"></i></span>
                                        <span class="fs-6 align-middle"><i class="bi bi-star-fill"></i></span>
